...
\begin{definition}
    Sia $q \in \mathbb{N}$ e sia $\mathbb{Z}_q = \{0, 1, ..., q - 1\}$. Dati $m$ vettori $a_1, a_2, ..., a_m$ di $k$ componenti ciascuno (formalmente, definiti sull'insieme $\mathbb{Z}^k_q$), si definisca $s = \{s_1, s_2, ..., s_k\} \in \mathbb{Z}^k_q$ vettore \textbf{segreto} ed $e = \{e_1, e_2, ..., e_m\} \in \mathbb{Z}^m_q$ vettore degli \textbf{errori}. [Work in Progress].
\end{definition}
\newpage
