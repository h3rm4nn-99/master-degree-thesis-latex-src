...
La configurazione scelta per l'utilizzo di tale libreria consiste in:
...
L'integrazione di tale libreria nei due progetti si effettua in due modi:

\begin{itemize}
    \item Nel caso di ArduPilot:
    \item Nel caso di QGroundControl:
\end{itemize}
