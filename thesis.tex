...
ed aggiungendo il flag \texttt{-loqs} in fase di compilazione del programma per comunicare al \textbf{linker} di effettuare il linking di tale libreria.
...
\begin{lstlisting}[language=xml, basicstyle=\fontsize{8}{13}\selectfont\ttfamily]
...
Il messaggio \texttt{CAPSULEACK} testimonia semplicemnte l'avvenuta ricezione della GCS di un messaggio \texttt{CAPSULE} ed in particolare contiene \textbf{il prossimo numero di sequenza atteso}.
